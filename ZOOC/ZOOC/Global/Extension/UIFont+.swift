...
extension UIFont{
    ...
    class var zoocCaption: UIFont {
        return UIFont(name: "Pretendard-Medium", size: 12)!
    }
    
    class var zoocSmallCaption: UIFont {
